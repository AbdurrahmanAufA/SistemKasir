...
Public Class Printer
    ...
    Public Shared Sub NewPrint()
        ...
        With PS1
            ...
            objprinter.PrinterSettings.DefaultPageSettings.PaperSize = New System.Drawing.Printing.PaperSize("dpack", 24, 14)
            .Margins.Left = 0
            .Margins.Right = 0
            .Margins.Top = 0
            .Margins.Bottom = 0
        ...
        AddHandler prn.PrintPage, AddressOf Document_PrintPage
    End Sub
    Public Shared Sub SetFont(ByVal FontFamily As String, ByVal emSize As Single, ByVal style As FontStyle)
    ...
    Public Shared Sub Print(ByVal text As String, ByVal arrWidth() As Integer)
        PrintDatalist = PrintDatalist.AddItemToDataList(PrintDatalist, PrintDatalist.Count, text, _myfont, arrWidth)
    End Sub

    Public Shared Sub Print(ByVal text As String, ByVal arrWidth() As Integer, ByVal arrFormat() As StringFormat)
        PrintDatalist = PrintDatalist.AddItemToDataList(PrintDatalist, PrintDatalist.Count, text, _myfont, arrWidth, arrFormat)
    End Sub

    Public Shared Sub Print(ByVal text As String, ByVal arrWidth() As Integer, ByVal iLeft As Integer)
